...
module.exports = {
  ...
  datastores: {
    ...
    ***************************************************************************/
    default: {
      ...
      //  For example:
      //  ```
      //  sails_datastores__default__url=mysql://admin:myc00lpAssw2D@db.nghom.com:3306/my_prod_db
      //  ```
      //--------------------------------------------------------------------------
  ...
  ***************************************************************************/
  security: {
    ...
    *                                                                          *
    * > Replace "https://nghom.com" with the URL of your production server.  *
  ...
  ***************************************************************************/
  sockets: {
    ...
    *                                                                          *
    * > Replace "https://nghom.com" etc. with the URL(s) of your app.        *
    * > Be sure to use the right protocol!  ("http://" vs. "https://")         *
    *                                                                          *
    ***************************************************************************/
    onlyAllowOrigins: [
      'https://nghom.com',
      'https://tamte.nghom.com',
    ],
  ...
  ***************************************************************************/
  custom: {
    baseUrl: 'https://nghom.com',
    internalEmailAddress: 'support@nghom.com',

    // mailgunDomain: 'mg.nghom.com',
    ...
    // For example:
    // ```
    // sails_custom__mailgunDomain=mg.nghom.com
